...
* caClient.BC.XXX.webhook.createOmniConfirmedTransactionWebHook ([docs](https://docs.cryptoapis.io/rest-apis/blockchain-as-a-service-apis/btc/index#btc-webhooks-create-omni-confirmed-transaction-webhook-endpoint))
* caClient.BC.XXX.webhook.createOmniTransactionConfirmationsWebHook ([docs](https://docs.cryptoapis.io/rest-apis/blockchain-as-a-service-apis/btc/index#btc-webhooks-create-omni-transaction-confirmations-webhook-endpoint))
* caClient.BC.XXX.webhook.createOmniTokenWebHook ([docs](https://docs.cryptoapis.io/rest-apis/blockchain-as-a-service-apis/btc/index#btc-webhooks-create-omni-token-webhook-endpoint))
