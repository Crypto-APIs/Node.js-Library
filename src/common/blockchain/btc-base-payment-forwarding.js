const BasePaymentForwarding = require('./base-payment-forwarding');

class BtcBasePaymentForwarding extends BasePaymentForwarding {
...
module.exports = BtcBasePaymentForwarding;
