...
-   `wifs` **[Array](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array)&lt;[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)>** Array of private ECDSA keys of the addresses (see example below)
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinInfo('mainnet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinBlock('mainnet', 546903).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinLatestBlock('mainnet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinAddressInfo('mainnet', '1DBrYbe5U7LGDcHA5tiLCxivZ7JZAGqGhJ').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.generateDogecoinAddress('mainnet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### getDogecoinAddressTransactions
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinAddressTransactions('mainnet', '3DrVotri9Rq2xcHqCMKpVUoyU6pvoWRtY3', 0, 10).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
var caClient = new CryptoApis(apiKey);
var addresses = ["1MfyBywPTSj9aAPr8cccCTcch71fd4vkDA", "1B5WsYR8m4axbmEMMifveDL2gtZjtpaFr5", "1KRYkrh3dAkeBWPwxDZhrz9u8xf5NRK9UH"];
caClient.createDogecoinWallet('mainnet', 'myWallet', addresses).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.createDogecoinHDWallet('mainnet', 'myHDWallet', 5, 'jr9023kes%kj').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.listDogecoinWallets('mainnet', true).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinWallet('mainnet', 'myHDWallet', true).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.addAddressToDogecoinWallet('mainnet', 'myWallet', ['1Eeu3eC2b35LWtjXeRMJMSfrDnfDEjNwW6']).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### generateAddressInDogecoinWallet
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.generateAddressInDogecoinWallet('mainnet', 'myWallet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### generateAddressInDogecoinHDWallet
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.generateAddressInDogecoinHDWallet('mainnet', 'myHDWallet', 2, 'jr9023kes%kj').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### deleteAddressFromDogecoinWallet
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.deleteAddressFromDogecoinWallet('mainnet', 'myWallet', '1GdnJh1r3xWsst7o7JXykgGD13AF4NSmh3').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.deleteDogecoinWallet('mainnet', 'myWallet', false).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinTransaction('mainnet', '54287345c01d64a3365166b380adf04e738ec52935f2751aead7ae60ff4fcb21').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinTransactionsFee('mainnet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### getDogecoinTransactionByBlockIndex
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinTransactionByBlockIndex('mainnet', '0000000000000000002523785a5a3a0f4a04536baf589f9c5fbf2b6273daf62b', 3).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### getDogecoinTransactionsByBlockIndex
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinTransactionsByBlockIndex('mainnet', 553394, 0, 3).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### getDogecoinUnconfirmedTransactions
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinUnconfirmedTransactions('mainnet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
var caClient = new CryptoApis(apiKey);
var txs = ['54287345c01d64a3365166b380adf04e738ec52935f2751aead7ae60ff4fcb21', '4ed3bbc8297b69a002ac7dc5fcf0acf01f6ffd92871c1027061a7eabc1e74623'];
caClient.dogecoinTransactionTrace('mainnet', txs).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinLatestTransactions('mainnet', 10).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### getDogecoinTransactionsHistory
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.getDogecoinTransactionsHistory('mainnet', true, 0, 5).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
caClient.createDogecoinTransaction('testnet', inputs, outputs, fee, wifs).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### createDogecoinHDWalletTransaction
...
caClient.createDogecoinHDWalletTransaction('testnet', walletName, password, fee, outputs, inputs, locktime).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
var caClient = new CryptoApis(apiKey);
var toSend = '';
caClient.sendDogecoinTransaction('testnet', toSend).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
var caClient = new CryptoApis(apiKey);
var txHex = '';
caClient.decodeRawDogecoinTransaction('mainnet', txHex).then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
-   `network` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Network name (mainnet or testnet)
-   `fromAddress` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Destination dogecoin address
-   `toAddress` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Target dogecoin address
-   `callbackURL` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Callback URL
-   `walletName` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Wallet created by current
-   `password` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Wallet password
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.dogecoinCreatePayment('mainnet', '12CHjjowV5koCpyMXHeYFhMQzd4KE6JUdF', '1DoAHYHRd72RBbScbr678vXhAwHPPfhY34', 'your callback url', 'myHDWallet', 'jr9023kes%kj').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.dogecoinListPayment('mainnet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.dogecoinDeletePayment('mainnet', '1f3e4771-ce6c-4b25-805b-cc27a38e2603').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### dogecoinCreateUnconfirmedTransactionWebHook
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.dogecoinCreateUnconfirmedTransactionWebHook('mainnet', 'your callback url').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.dogecoinCreateNewBlockWebHook('mainnet', 'your callback url').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
### dogecoinCreateConfirmedTransactionWebHook
...
### dogecoinCreateAddressTransactionWebHook
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.dogecoinCreateAddressTransactionWebHook('mainnet', 'your callback url', '1GdnJh1r3xWsst7o7JXykgGD13AF4NSmh3').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.listAllDogecoinHooks('mainnet').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
...
const apiKey = 'your API key';
var caClient = new CryptoApis(apiKey);
caClient.deleteDogecoinWebHook('mainnet', '232c9f47-ff47-401c-9681-9d854e497c8a').then(function(result) {
    console.log(result);
}, function(error) {
    console.log(error);
});
